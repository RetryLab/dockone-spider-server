...
app.get('/user/machines/count', user.machine.count.bind(user.machine));
...
app.get('/user/profiles/count/:machineId?', user.profile.count.bind(user.profile));
app.get('/user/profiles/:machineId?', user.profile.find.bind(user.profile));
// analysis stats
app.get('/user/analysis/:machineId?/:profileId?', analysis.find.bind(analysis));
//docker active
app.get('/user/clients/:machineId?/:profileId?', docker.active.bind(docker));
