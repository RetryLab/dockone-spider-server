...
app.put('/user/profile', user.profile.update.bind(user.profile));
app.get('/user/profile', user.profile.get.bind(user.profile));
app.delete('/user/profile', user.profile.delete.bind(user.profile));
